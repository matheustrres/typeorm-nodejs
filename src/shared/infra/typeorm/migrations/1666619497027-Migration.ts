...
export class Migration1666619497027 implements MigrationInterface {
  public name: string = 'Migration1666619497027'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "room_subject" (
        ...
        CONSTRAINT "PK_6b3738a7b93c77fd6d9333b638a" PRIMARY KEY ("room_id", "subject_id")
      )
    `);
    ...
    await queryRunner.query(`
      ALTER TABLE 
        "room_subject" 
      ADD 
        CONSTRAINT "FK_f227421d2ef64ab086261ac07fd" FOREIGN KEY ("room_id") REFERENCES "subjects"("id") ON DELETE CASCADE ON UPDATE CASCADE
    `);
    await queryRunner.query(`
      ALTER TABLE 
        "room_subject" 
      ADD 
        CONSTRAINT "FK_a05f10c497f5f7db3022664a6d6" FOREIGN KEY ("subject_id") REFERENCES "rooms"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
    `);
  }
